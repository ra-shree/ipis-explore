...
- `election_2074` (2017) is missing Madhesh Province entirely from the raw source (616 of 753 palikas have any record); `election_2079` (2022) has full coverage. A palika with no head-race data for the selected year renders as `NO_DATA_TIER` ("No data"), not assigned a win/loss tier.
